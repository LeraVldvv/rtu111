...
import static imperative.PerfectNumber.ABUNDANT;
import static imperative.PerfectNumber.DEFICIENT;
import static imperative.PerfectNumber.PERFECT;
...
public class PerfectNumberTest {
   ...
   @Test
    public void testDivisors1() {
        ...
        int n = 1;
        assertArrayEquals(expected, PerfectNumber.devisors(n).toArray());
    }
